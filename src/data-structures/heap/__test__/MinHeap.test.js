...
describe("MinHeap", () => {
  ...
  xit("should poll items from the heap and heapify it down", () => {
    const minHeap = new MinHeap();
  ...
  xit("should heapify down through the right branch as well", () => {
    const minHeap = new MinHeap();
  ...
  xit("should be possible to find item indices in heap", () => {
    const minHeap = new MinHeap();
  ...
  xit("should be possible to remove items from heap with heapify down", () => {
    const minHeap = new MinHeap();
  ...
  xit("should be possible to remove items from heap with heapify up", () => {
    const minHeap = new MinHeap();
  ...
  xit("should be possible to remove items from heap with custom finding comparator", () => {
    const minHeap = new MinHeap();
    minHeap.add("dddd");
    minHeap.add("ccc");
    minHeap.add("bb");
